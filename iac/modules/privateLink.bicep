...
var privateLinkConnectionName  = take('pl-conn-${logAnalyticsWorkspaceName}${uniqueData}', 80)
var privateLinkEndpointName = take('pl-${logAnalyticsWorkspaceName}${uniqueData}', 80)
var privateLinkScopeName = take('pl-scope-${logAnalyticsWorkspaceName}${uniqueData}', 80)
var privateLinkScopeResourceName = take('pl-scres-${logAnalyticsWorkspaceName}${uniqueData}', 80)
