...
# docker build --no-cache -t agentcontainerubuntu1804:latest -f ubuntu1804-baseline/Dockerfile .
# docker build -t agentcontainerubuntu1804:latest -f ubuntu1804-baseline/Dockerfile .
